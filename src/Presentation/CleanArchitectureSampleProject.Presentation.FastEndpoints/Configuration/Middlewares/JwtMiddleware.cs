namespace CleanArchitectureSampleProject.Presentation.FastEndpoints.Configuration.Middlewares;
...
public sealed class JwtMiddleware(RequestDelegate next, ILogger<JwtMiddleware> logger)
{
    ...
    private static CrossCuttingConcerns.Results<AuthResponseType, CrossCuttingConcerns.BaseError> GetResponseType(HttpContext context)
    {
        ...
        return context.Response.StatusCode switch
        {
            ...
            _ => new CrossCuttingConcerns.BaseError("")
        };
    }
}
