...
public sealed class GetAllProducts(ILogger<GetAllProducts> logger, IProductUseCases productUseCases) : 
    EndpointWithoutRequest<Results<Ok<FrozenSet<GetProductOutput>>, NoContent, ProblemHttpResult>>
{
    ...
    public override async Task<Results<Ok<FrozenSet<GetProductOutput>>, NoContent, ProblemHttpResult>> ExecuteAsync(CancellationToken cancellation)
    {
